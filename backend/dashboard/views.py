...
from shopping.models import ShoppingList, Quote
...
def shopping_list_view(request):
    ...
    context = {
        ...
        'status_choices': ShoppingList.__meta.get_field('status').choices
    }
...
def create_quote(request, list_id):
    ...
    return render(request, 'dashboard/quotes/create.htnl', context)
